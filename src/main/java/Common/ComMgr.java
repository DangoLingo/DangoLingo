...
public class ComMgr
{
    ...
    /***********************************************************************
     * COLOR		: 색상 상수 관리<br><br>
	 * BLACK, RED, GREEN, YELLOW
	 * BLUE, PURPEL, CYAN, WHITE,
	 * RESET
     ***********************************************************************/
	public enum COLOR
	{
	...
	/***********************************************************************
	 * PrintXY()		: 콘솔창에 특정 색상으로 문자열 출력
	 * @param x			: 콘솔창 x 좌표
	 * @param y			: 콘솔창 y 좌표
	 * @param Message	: 출력 할 문자열
	 * @return void		: None
	 ***********************************************************************/
	public static void PrintColor(ComMgr.COLOR TextColor, String Message)
	{
		try
		{
			System.out.printf("%s%s%s", TextColor.GetColor(), Message, ComMgr.COLOR.RESET.GetColor());
		}
		catch (Exception Ex)
		{
			throw Ex;
	...
	/***********************************************************************
	 * PrintXY()		: 콘솔창에 특정 색상으로 문자열 출력(개행)
	 * @param x			: 콘솔창 x 좌표
	 * @param y			: 콘솔창 y 좌표
	 * @param Message	: 출력 할 문자열
	 * @return void		: None
	 ***********************************************************************/
	public static void PrintColorln(ComMgr.COLOR TextColor, String Message)
	{
		try
		{
			System.out.printf("%s%s%s\n", TextColor.GetColor(), Message, ComMgr.COLOR.RESET.GetColor());
		}
		catch (Exception Ex)
		{
			throw Ex;
