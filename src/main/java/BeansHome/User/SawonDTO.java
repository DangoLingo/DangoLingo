...
public class SawonDTO
{
	...
	// 전역변수 관리 - 필수영역(인스턴스변수)
	// —————————————————————————————————————————————————————————————————————————————————————
	/** sabun : Beans 사번 필드(JSP 입력 객체와 1:1 대응, 숫자로 시작) */
	private Integer sabun = 0;
	/** name : Beans 성명 필드(JSP 입력 객체와 1:1 대응, 소문자로 시작) */
	private String	name = null;
	/** age : Beans 나이 필드(JSP 입력 객체와 1:1 대응, 숫자로 시작) */
	private Integer age = 0;
	/** gender : Beans 성별 필드(JSP 입력 객체와 1:1 대응, 소문자로 시작) */
	private String 	gender = null;
	/** tel : Beans 전화번호 필드(JSP 입력 객체와 1:1 대응, 숫자로 시작) */
	...
	/** bdate : Beans 생년월일 필드(JSP 입력 객체와 1:1 대응, 소문자로 시작) */
